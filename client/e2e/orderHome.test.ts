...
test.describe.serial('testing place order and order summary in sequence', () => {
  ...
  test('user shall be able to cancel the order', async ({ page }) => {
    await asUser(page, userAsUser, async () => {
      //cancel order
      await page
  ...
  test('order in order summary', async ({ page }) => {
    await asUser(page, userAsUser, async () => {
